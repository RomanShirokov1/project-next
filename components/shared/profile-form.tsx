...
import { TFormChangeValues, formChangeSchema } from './modals/auth-modal/forms/schemas';
...
export const ProfileForm: React.FC<Props> = ({ data }) => {
  const form = useForm({
    resolver: zodResolver(formChangeSchema),
    defaultValues: {
  ...
  const onSubmit = async (data: TFormChangeValues) => {
    try {
